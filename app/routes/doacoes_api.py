...
def atualizar_doacao(id):
    ...
    doacao.pessoa_id = data.get('pessoa_id', doacao.pessoa_id)
    doacao.data_doacao = data.get('data_doacao', doacao.data_doacao)
    doacao.valor_doacao = data.get('valor_doacao', doacao.valor_doacao)
    doacao.tipo_doacao = data.get('tipo_doacao', doacao.tipo_doacao)
    doacao.obs_doacao = data.get('obs_doacao', doacao.obs_doacao)
